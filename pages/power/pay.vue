	...
	<view class="page">
		...
		<view class="banner margin0 borderBottom flex-column padding-column30 flex-between">
			...
			<view class="flex-between">
				...
				<view class="val">x{{quantity}}</view>
			</view>
			<view class="flex-between">
				<view class="name">支付金额</view>
				<view class="val" v-if="active==1">{{cost/coinPrice }} USDT</view>
        ...
        methods: {
			...
			finish(e){
				this.$Ajax('/MartianOrePool/payment',{
					...
					money: this.acive == 1 ? this.cost/this.coinPrice : this.cost,
