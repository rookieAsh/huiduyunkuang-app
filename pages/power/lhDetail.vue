<template>
	<view class="page">
		...
		<view class="pic margin0">
			<image src="../../static/images/app/mine.png" mode=""></image>
		</view>
		<view class="countDowm margin30-0 padding-row30 flex-between align-center">
			<view class="left flex">
				<view class="name">{{ obj.cmc_subarea}}</view>
		...
		<!-- <view class="price padding-row30">${{obj.activity_price}} <text>${{obj.mill_cost}}</text></view> -->
		<view class="mineName padding-row30">矿机型号：xxxxxx</view>
		<view class="time padding-row30">开始挖矿时间：2021-03-01</view>
		
		<view class="infoBox margin30-0 padding20">
			<view class="th flex">
				<view class="thLi">矿机算力</view>
				<view class="thLi">矿机功耗</view>
				<view class="thLi">电费</view>
			</view>
			<view class="td flex">
				<view class="tdLi">{{obj.hashrate}}/台</view>
				<view class="tdLi">{{obj.power_diss}}/台</view>
				<view class="tdLi">{{obj.electric_charge}}元/天</view>
			</view>
			<view class="placeholder30"></view>
			<view class="th flex">
				<view class="thLi">预计日产币</view>
				<view class="thLi">管理费</view>
				<view class="thLi">回本天数</view>
			</view>
			<view class="td flex">
				<view class="tdLi">{{obj.earnings}}</view>
				<view class="tdLi">{{obj.administrative_fee}}</view>
				<view class="tdLi">{{obj.Back_tothe}}</view>
			</view>
		</view>
		...
		<view class="bottomOp flex-between align-center fixed">
			<view class="left flex align-center">
				<text>数量</text>
				<view class="div relative" @click="quantity===1? '' : quantity--">
			...
			<view class="btn text-center" @click="giLink()">购买 ￥{{obj.activity_price * quantity}}</view>
		</view>
		...
		<view class="text padding-row30" v-html="obj.description" v-if="ver==0"></view>
		
		<view v-else class="cnt margin0" v-else>
			<view class="cell_th flex">
				<view class="li">挖矿币种</view>
				<view class="li">ETH</view>
			</view>
			<view class="cell_td flex">
				<view class="li">额定算力</view>
				<view class="li">ETH 360MH/s ±5％</view>
			</view>
			<view class="cell_td flex">
				<view class="li">显卡型号</view>
				<view class="li">AMD RX 580*12 张</view>
			</view>
			<view class="cell_td flex">
				<view class="li">显存</view>
				<view class="li">8G</view>
			</view>
			<view class="cell_td flex">
				<view class="li">墙上功耗</view>
				<view class="li">ETH 1650W±10%</view>
			</view>
			<view class="cell_td flex">
			...
			<!-- <view class="cell_td flex">
				<view class="li">额定电压</view>
				<view class="li">220V</view>
			</view> -->
			<view class="cell_td flex">
				<view class="li">外形尺寸</view>
				<view class="li">410mm(L)*315mm*180mm</view>
			</view>
			<view class="cell_td flex">
				<view class="li">毛重</view>
				<view class="li">21 KG</view>
			</view>
			
			<view class="cell_td flex">
				<view class="li">净重</view>
				<view class="li">18.5 KG</view>
			</view>
			<view class="cell_td flex">
				<view class="li">冷却</view>
				<view class="li">3 风扇</view>
			</view>
			<!-- <view class="cell_td flex">
				<view class="li">噪音</view>
				<view class="li">80 dB</view>
			</view> -->
			<view class="cell_td flex">
				<view class="li">工作温度</view>
				<view class="li">0℃至40℃</view>
			</view>
			<!-- <view class="cell_td flex">
				<view class="li">工作湿度</view>
				<view class="li">5%RH-95%RH，非凝露</view>
			</view> -->
			<!-- <view class="cell_td flex">
				<view class="li">网络连接</view>
				<view class="li">以太网</view>
			</view> -->
			<view class="cell_td flex" style="height: 120rpx;">
				<view class="li" style="line-height: 120rpx;">电源连接方式</view>
				<view class="li" style="line-height: 40rpx;">每台显卡矿机10个6pin口都需要连接，推荐使用独立电源给整机供电</view>
			</view>
			<view class="cell_td flex">
			...
			<view class="cell_td flex">
				...
				<view class="li">4GB</view>
			</view>
			<view class="cell_td flex" style="height: 120rpx;">
				<view class="li" style="line-height: 120rpx;">系统类型</view>
				<view class="li" style="line-height: 60rpx;">64位操作系统，基于x64的处理器</view>
			</view>
			<!-- <view class="cell_td flex">
				<view class="li">系统</view>
				<view class="li">矿宝 OS</view>
			</view> -->
		</view>
...
<script>
	export default {
        ...
        methods: {
			...
			getDetail(){
				this.$Ajax("/MartianOrePool/selectMillAllById",{
					productId:this.productId
				},(res)=>{
					this.obj = res.data[0]
					this.timestamp = this.obj.end_time;
				})
			},
			giLink(){
				if(!this.checked) return this.$u.toast("请确认已阅读矿机租赁、购买协议！")
				let obj = {};
				obj.price = this.obj.activity_price;
				obj.quantity = this.quantity;
				obj.productId = this.productId;
				obj.charge =  this.obj.electric_charge;
				uni.setStorageSync('data', obj );
				uni.navigateTo({
					url:'./mineBuy'
				})
			},
